...
const Cart = () => {
  ...
  return (
    <div className="bg-half-transparent w-screen h-full fixed nav-item top-0 right-0">
      <div className="float-right h-screen bg-white dark:bg-secondary-dark-bg w-400 dark:text-gray-200 overflow-auto">
        ...
        {cartData?.map((item, index) => (
          <div key={index}>
            <div>
              <div className="flex items-center leading-8 gap-5 border-b-1 border-black dark:border-gray-600 p-4">
                <img
                  src={item.image}
                  alt="card image"
                ...
                <div>
                  ...
                  <div className="flex gap-4 mt-2 items-center">
                    ...
                    <div className="flex items-center border-1 border-r-0 border-color rounded dark:border-white">
                      ...
                      <p className="p-2 border-r-1 border-color dark:border-gray-600 text-black dark:text-white">
                        0
                      </p>
